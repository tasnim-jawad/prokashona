                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="d-flex gap-1 flex-wrap text-nowrap">
                                    <label v-for="employee in all_employee" :key="employee.id" :for="'emp'+employee.id">
                                        <input type="checkbox" :value="employee.id" :checked="users_id?.includes(employee.id)" name="user_id[]" :id="'emp'+employee.id" class="form-check-input">
                                        <span>
                                            {{ employee.first_name }}
                                            {{ employee.last_name }}
                                        </span>
