<template>
    <div class="multiple_select_body">
        <div class="multiple_select_data" id="user_id" @click="call_store(`set_user_show_management_modal`,true)">
                    ...
                    <table class="table table-hover table-bordered">
                        <thead class="table-light">
                            <tr>
                                ...
                                <user-table-th :sort="false" :ariaLable="`id`" :tkey="`id`" :title="`ID`" />
                                <user-table-th :sort="false" :tkey="`photo`" :title="`Photo`" />
                                <user-table-th :sort="false" :tkey="`first_name`" :title="`Name`" />
                                <user-table-th :sort="false" :tkey="`mobile_number`" :title="`Mobile NO`" />
                                <user-table-th :sort="false" :tkey="``" :title="`Advanced`" />
                                <user-table-th :sort="false" :tkey="``" :title="`Due`" />
...
export default {
    ...
    methods: {
        ...
        handle_pagination: async function(page=1){
            this[`set_${store_prefix}_sakha_page`](page);
        },
    },
    computed: {
        ...mapGetters([
