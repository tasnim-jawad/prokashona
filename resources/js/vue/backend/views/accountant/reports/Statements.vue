        ...
        <div class="card list_card">
            ...
            <div class="ledger_book card-body text-nowrap">
                ...
                <div class="ledger_row" v-for="i in statements" :key="i.id">
                    ...
                    <div class="ledger_col">{{ i.balance?.toFixed(2) }}</div>
                </div>
                ...
                <div class="ledger_row ledger_footer">
                    ...
                    <div class="ledger_col amount">{{ statement_total['total_income']?.toFixed(2) }}</div>
                    <div class="ledger_col amount">{{ statement_total['total_expense']?.toFixed(2) }}</div>
                    <div class="ledger_col amount">{{ statement_total['total_balance']?.toFixed(2) }}</div>
                </div>
            </div>
