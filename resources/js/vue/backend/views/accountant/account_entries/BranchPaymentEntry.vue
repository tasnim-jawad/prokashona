    ...
    <div class="container">
        <div class="card list_card">
            <div class="card-header">
                <h4>Branch Payment Entry</h4>
                <div class="btns">
                    <!-- <router-link :to="{ name: `All${route_prefix}` }" class="btn rounded-pill btn-outline-warning" >
                        <i class="fa fa-arrow-left me-5px"></i>
                        Back
                    </router-link> -->
                    <router-link v-if="branch[0]" :to="{ name: `BranchDuePayment`, params:{user_id:branch[0]?.id} }" class="btn rounded-pill btn-outline-warning" >
                        <i class="fa fa-plus me-5px"></i>
                        Adjust Due
                    </router-link>
                </div>
            </div>
            <form @submit.prevent="call_store(`store_branch_payment`,$event.target)" class="create_form" autocomplete="false">
                <div class="card-body">
                        ...
                        <div class="col-lg-10">
                            <div class="admin_form form_1">
                                ...
                                <div class=" form-group full_width d-grid align-content-start gap-1 mb-2 " >
                                    ...
                                    <SakhaManagementModal></SakhaManagementModal>
                                </div>

                                <div>
                                    <ul>
                                        <li>
                                            Advanced: {{ branch[0]?.advanced }}
                                        </li>
                                        <li>
                                            Due: {{ branch[0]?.due }}
                                        </li>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <div>
                                        <ul id="account_number_id" class="mt-2">
...
import SakhaManagementModal from "../../users/components/SakhaManagementModal.vue"
/** store and route prefix for export object use */
import PageSetup from './PageSetup';
const {route_prefix, store_prefix} = PageSetup;

export default {
    components: { InputField, CateogryTypesModal, CustomerModal, SakhaManagementModal },
    data: function(){
        return {
    ...
    computed: {
        ...mapGetters({
            ...
            branch: `get_user_selected`,
        }),
        ...mapState({
            branches:({user_modules})=>user_modules.users,
            // branch:({user_modules})=>user_modules.user,
        })
    }
};
</script>
