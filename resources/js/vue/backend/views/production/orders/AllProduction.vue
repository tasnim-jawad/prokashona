                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <!-- <tr v-for="item in data" :key="item.id"> -->
                            ...
                            <td>
                                <span v-if="item.production_status[item.production_status.length-1]">
                                    {{ item.production_status[item.production_status.length-1]["description"] }}
                                </span>
                            </td>
                            <td>
                                <div class="table_actions">
...
export default {
    ...
    created: function(){
        this[`fetch_all_productions`]();
    },
    methods: {
        ...mapActions([
            `fetch_all_productions`,
